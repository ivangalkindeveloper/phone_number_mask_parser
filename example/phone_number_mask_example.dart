...
void main() {
  ...
  final PhoneNumberMaskResult _result0 = _phoneNumberMask0.apply(phoneNumber: _phone0);
  print(_phone0);
  ...
  final PhoneNumberMaskResult _result5 = _phoneNumberMask1.apply(phoneNumber: _phone5);
  print(_phone5);
  ...
  final PhoneNumberMaskResult _result7 = _phoneNumberMask2.apply(phoneNumber: _phone7);
  print(_phone7);
  ...
  final PhoneNumberMaskResult _result8 = _phoneNumberMask3.apply(phoneNumber: _phone8);
  print(_phone8);
