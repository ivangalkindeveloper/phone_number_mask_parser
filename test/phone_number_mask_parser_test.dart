...
void main() {
  ...
  test("Checking mask", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "+44 9233 032391");
    ...
    expect(result1.PhoneNumberMaskParsered, "+1 (684) 910 1234");
    ...
    expect(result2.PhoneNumberMaskParsered, "+7 (984) 910-12-34");
    ...
    expect(result3.PhoneNumberMaskParsered, "+7 (984) 910-12-34");
    ...
    expect(result4.PhoneNumberMaskParsered, "+7 (784) 910 1234");
  ...
  test("Checking target mask", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "+93 02 (9302) 3049");
    ...
    expect(result1.PhoneNumberMaskParsered, "+67 22 (3585) 9394");
  ...
  test("Checking default mask", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "+049 233 0323 9120");
    expect(result0.country?.title, null);
    expect(result0.country?.iso2Code, null);
    expect(result0.country?.phoneCode, null);
    expect(result0.country?.mask, null);
    ...
    expect(result1.PhoneNumberMaskParsered, "+0492 (3303) 23 91");
    expect(result1.country?.title, null);
    expect(result1.country?.iso2Code, null);
    expect(result1.country?.phoneCode, null);
    expect(result1.country?.mask, null);
  ...
  test("Checking endless mask", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "+1 (492) 330 3239 12034");
    ...
    expect(result2.PhoneNumberMaskParsered, "+420 123 456 789 6");
    ...
    expect(result1.PhoneNumberMaskParsered, "+370 203 3002");
  ...
  test("Checking small number", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "+34 566");
  ...
  test("Checking dirty number", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "+251 33 043 0339 43343");
  ...
  test("Checking plus flag", () {
    ...
    expect(result0.PhoneNumberMaskParsered, "299 307978");
