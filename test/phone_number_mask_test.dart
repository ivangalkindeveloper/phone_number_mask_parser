...
void main() {
  test("Checking mask", () {
    ...
    final PhoneNumberMaskResult result0 = phoneNumberMask.apply(phoneNumber: phone0);
    ...
    final PhoneNumberMaskResult result1 = phoneNumberMask.apply(phoneNumber: phone1);
    ...
    final PhoneNumberMaskResult result2 = phoneNumberMask.apply(phoneNumber: phone2);
    ...
    final PhoneNumberMaskResult result3 = phoneNumberMask.apply(phoneNumber: phone3);
    ...
    final PhoneNumberMaskResult result4 = phoneNumberMask.apply(phoneNumber: phone4);
  ...
  test("Checking target mask", () {
    ...
    final PhoneNumberMaskResult result5 = phoneNumberMask.apply(phoneNumber: phone5);
    ...
    final PhoneNumberMaskResult result6 = phoneNumberMask.apply(phoneNumber: phone6);
  ...
  test("Checking default mask", () {
    ...
    final PhoneNumberMaskResult result7 = phoneNumberMask0.apply(phoneNumber: phone7);
    ...
    final PhoneNumberMaskResult result8 = phoneNumberMask1.apply(phoneNumber: phone8);
  ...
  test("Checking endless mask", () {
    ...
    final PhoneNumberMaskResult result9 = phoneNumberMask0.apply(phoneNumber: phone9);
    ...
    final PhoneNumberMaskResult result10 = phoneNumberMask1.apply(phoneNumber: phone10);
  ...
  test("Checking small number", () {
    ...
    final PhoneNumberMaskResult result11 = phoneNumberMask.apply(phoneNumber: phone11);
  ...
  test("Checking dirty number", () {
    ...
    final PhoneNumberMaskResult result12 = phoneNumberMask.apply(phoneNumber: phone12);
  ...
  test("Checking plus flag", () {
    ...
    final PhoneNumberMaskResult result13 = phoneNumberMask.apply(phoneNumber: phone13);
